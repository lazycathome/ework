...
ConfigUserFilesPath = "/userfiles/"  '上传路径
...
ConfigFileTypesPath.Add "File", ConfigUserFilesPath & "file/"& Year(Date()) &"-"& Month(Date()) &"/"  '按日期生成文件夹名
ConfigFileTypesAbsolutePath.Add "File", ""
ConfigQuickUploadPath.Add "File", ConfigUserFilesPath & "file/"& Year(Date()) &"-"& Month(Date()) &"/" '按日期生成文件夹名
ConfigQuickUploadAbsolutePath.Add "File", ""

ConfigAllowedExtensions.Add	"Image", "bmp|gif|jpeg|jpg|png"
ConfigDeniedExtensions.Add	"Image", ""
ConfigFileTypesPath.Add "Image", ConfigUserFilesPath & "image/"& Year(Date()) &"-"& Month(Date()) &"/" '按日期生成文件夹名
ConfigFileTypesAbsolutePath.Add "Image", ""
ConfigQuickUploadPath.Add "Image", ConfigUserFilesPath & "image/"& Year(Date()) &"-"& Month(Date()) &"/" '按日期生成文件夹名
ConfigQuickUploadAbsolutePath.Add "Image", ""

ConfigAllowedExtensions.Add	"Flash", "swf|flv"
ConfigDeniedExtensions.Add	"Flash", ""
ConfigFileTypesPath.Add "Flash", ConfigUserFilesPath & "flash/"& Year(Date()) &"-"& Month(Date()) &"/" '按日期生成文件夹名
ConfigFileTypesAbsolutePath.Add "Flash", ""
ConfigQuickUploadPath.Add "Flash", ConfigUserFilesPath & "flash/"& Year(Date()) &"-"& Month(Date()) &"/" '按日期生成文件夹名
...
ConfigFileTypesPath.Add "Media", ConfigUserFilesPath & "media/"& Year(Date()) &"-"& Month(Date()) &"/" '按日期生成文件夹名
ConfigFileTypesAbsolutePath.Add "Media", ""
ConfigQuickUploadPath.Add "Media", ConfigUserFilesPath & "media/"& Year(Date()) &"-"& Month(Date()) &"/" '按日期生成文件夹名
