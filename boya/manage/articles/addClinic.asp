   ...
   <tr>
     <td valign="middle"><table width="90%" border="0" align="center" cellpadding="2" cellspacing="0">
       ...
       <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" bgcolor="#CCCCCC">
         <tr>
           <td height="30" align="right" valign="middle" bgcolor="#FFFFFF"><span class="red">* </span>名称：</td>
           <td height="30" bgcolor="#FFFFFF"><input id="subject" name="subject" type="text" value="" /></td>
         </tr> 
         <tr bgcolor="#FAFAFA">
           <td width="15%" height="30" align="right" valign="middle"><span class="red">* </span>所属栏目：</td>
           <td width="85%" column="0" id="columnList"></td>
         </tr>
         <tr>
         ...
         <!--
         <tr>
           <td height="30" align="right" valign="middle" bgcolor="#FFFFFF"><span class="red">* </span>问题分析：</td>
           <td bgcolor="#FFFFFF">
           <% createFckEditor "","summary",240,700,"Default" %>
           </td>
         </tr>
         -->
         <tr bgcolor="#FAFAFA">
           <td width="15%" height="30" align="right" valign="middle"><span class="red">* </span>内容：</td>
...
$(document).ready(function(){
	$.column.getColumnList("typeId=2","../column/queryColumn.asp");
	$("#created").datepick({
		changeMonth: true,
		numberOfMonths: 1,
