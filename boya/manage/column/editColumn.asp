...
<form name="form1"  action="updateColumn.asp" method="post" id="userInfoForm">
     ...
     <td valign="top"><table width="90%" border="0" align="center" cellpadding="2" cellspacing="0">
       ...
       <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" bgcolor="#CCCCCC">
         <tr>
           ...
           <td height="35" bgcolor="#FFFFFF" valign="middle"><input id="name" name="name" type="text" maxlength="32" value="<%=columnName%>" /></td>
         </tr> 
         <tr bgcolor="#FAFAFA">
           <td width="31%" height="45" align="right" valign="middle">所属栏目：</td>
           <td width="69%" isId="<%=id%>" column="<%=parentId%>" id="columnList" valign="middle"></td>
         </tr>
         <tr>
           <td height="45" align="right" valign="middle" bgcolor="#FFFFFF"><span class="red">* </span>是否显示：</td>
           <td bgcolor="#FFFFFF" valign="middle"><input id="display" name="display" <%=display%> type="radio" value="0" />是<input <%=display1%> id="display" name="display" type="radio" value="1" />否</td>
         </tr>
         <tr bgcolor="#FAFAFA">
...
$(document).ready(function(){
	$.column.getColumnList("typeId=<%=typeId%>");
