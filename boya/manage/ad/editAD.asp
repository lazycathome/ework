...
<body>
<form name="form1"  action="updateAD.asp" method="post" id="userInfoForm">
     ...
     <td valign="top"><table width="90%" border="0" align="center" cellpadding="2" cellspacing="0">
       ...
       <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" bgcolor="#CCCCCC">
         <tr>
           ...
           <td height="35" bgcolor="#FFFFFF" valign="middle"><input id="name" name="name" type="text" maxlength="32" value="<%=adName%>" /></td>
         </tr> 
         <tr bgcolor="#FAFAFA">
         ...
         <tr>
           ...
           <td bgcolor="#FFFFFF" valign="middle"><input id="typeId" name="typeId" checked="checked" type="radio" value="1" />flash<input id="typeId" name="typeId" type="radio" value="2" />幻灯片<input id="typeId" name="typeId" type="radio" value="3" />图片</td>
         </tr>
         <tr bgcolor="#FAFAFA">
           <td height="45" align="right" valign="middle">广告类容：</td>
           <td valign="middle">
            <% createFckEditor "","content",320,700,"Default" %>
           </td>
         </tr>
         <tr>
