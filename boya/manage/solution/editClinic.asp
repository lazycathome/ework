...
<body>
<form name="userInfoForm"  action="updateSolution.asp" method="post" id="userInfoForm">
     ...
     <td valign="middle"><table width="90%" border="0" align="center" cellpadding="2" cellspacing="0">
       ...
       <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" bgcolor="#CCCCCC">
         ...
         <tr bgcolor="#FAFAFA">
           ...
           <td width="85%" column="<%=articleId%>" id="articleList"></td>
         </tr>
         <tr>
         ...
         <tr bgcolor="#FAFAFA">
           ...
           <td height="30" bgcolor="#FFFFFF"><input id="time" name="time" type="text" value="<%=times%>" /></td>
         </tr>
         <tr>
           <td height="30" align="right" valign="middle" bgcolor="#FFFFFF">服务期：</td>
           <td height="30" bgcolor="#FFFFFF"><input id="expireTime" name="expireTime" type="text" value="<%=expireTime%>" /></td>
         </tr>
         <tr bgcolor="#FAFAFA">
           <td height="30" align="right" valign="middle" bgcolor="#FFFFFF">服务类型：</td>
           <td height="30" bgcolor="#FFFFFF"><input id="type" name="type" type="text" value="<%=types%>" /></td>
         </tr>
         <tr>
