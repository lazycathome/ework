   ...
   <tr>
     <td valign="top"><table width="90%" border="0" align="center" cellpadding="2" cellspacing="0">
       ...
       <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" bgcolor="#CCCCCC">
         <tr>
           <td height="45" align="right" valign="middle" bgcolor="#FFFFFF"><span class="red">* </span>留言标题：</td>
         ...
         <tr bgcolor="#FAFAFA">
          ...
          <tr bgcolor="#FAFAFA">
           <td height="45" align="right" valign="middle">回复内容：</td>
           <td valign="middle"><textarea cols="40" rows="5" name="replyContent"></textarea></td>
         </tr>
         <tr>
