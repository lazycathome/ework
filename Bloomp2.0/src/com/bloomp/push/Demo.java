...
//		}
		...
		for(int i = 0; i < 100; i++){
			...
			xg.demoPushSingleDeviceMessage();
		}
...
//      System.out.println(ret);
	...
	{
		XingeApp xinge = new XingeApp(2100078985, "82d7e35f1c1a2fbe2a3a6a39427a8705");
		Message message = new Message();
		message.setTitle("title");
		message.setContent("content");
		message.setType(Message.TYPE_MESSAGE);
		message.setExpireTime(86400);
		JSONObject ret = xinge.pushSingleDevice("fe1615f22a8e48214f31a75b086bd58b20d3e58b", message);
