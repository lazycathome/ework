...
public class VideoUtils {
	public static void main(String[] args) {  
		...
		getVideoFormatInfo(videoPath);
	  
	}  
	     
	public static Object[] getVideoFormatInfo(String videoPath){
	    ...
	    try {  
	        ...
	        if(matcherVideo.contains(result, patternVideo)){  
	            ...
	            data[1] = re.group(3);
	            System.out.println(re.group(3).split("x")[1]);
	        }  
...
//	    	video.setSize(new VideoSize(400, 300));
	    ...
	    public static boolean getVideoPicPath(String sourcePath, String path){
...
//	        cutpic.add("800*280"); // 添加截取的图片大小为350*240
            ...
            try {
				...
				System.out.println("create videoPic error");
			} 
            return false;
	    }
